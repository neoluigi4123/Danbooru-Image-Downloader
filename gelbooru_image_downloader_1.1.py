...
current_version = 1.1  # Current version of the script
...
def rename_files_by_modification_time(directory):
    ...
    for i, (filename) in enumerate(files_with_mtime):
